...
class DummyDataGenerator {
    ...
    private func generateHardcodedOrders() -> [Order] {
        ...
        for (index, orderData) in hardcodedOrderData.enumerated() {
    ...
    private func getHardcodedOrderData() -> [HardcodedOrderData] {
        return [
            ...
            HardcodedOrderData(daysAgo: 1, hourOffset: 10, reference: "ORD-006", customerName: "David Wilson", status: .fulfilled, platform: .amazon, shippingCost: 5.99, sellingFees: 15.00, additionalCosts: 0.0, shippingMethod: "Amazon Prime", trackingReference: "AMZ123ABC", customerShippingCharge: 0.0, deliveryMethod: .delivered, revenue: 199.99, profit: 179.00, productKeyword: "AirPods", quantity: 1),
            HardcodedOrderData(daysAgo: 1, hourOffset: 14, reference: "ORD-007", customerName: "Sophie Turner", status: .fulfilled, platform: .ebay, shippingCost: 4.50, sellingFees: 9.25, additionalCosts: 0.0, shippingMethod: "Royal Mail", trackingReference: "RG456789123GB", customerShippingCharge: 5.99, deliveryMethod: .delivered, revenue: 94.99, profit: 81.24, productKeyword: "Sneakers", quantity: 1),
            HardcodedOrderData(daysAgo: 1, hourOffset: 16, reference: "ORD-008", customerName: "Oliver Smith", status: .shipped, platform: .amazon, shippingCost: 3.99, sellingFees: 7.50, additionalCosts: 0.0, shippingMethod: "DPD", trackingReference: "DPD456789123", customerShippingCharge: 4.99, deliveryMethod: .delivered, revenue: 0.0, profit: 0.0, productKeyword: "Watch", quantity: 1),
            HardcodedOrderData(daysAgo: 2, hourOffset: 9, reference: "ORD-009", customerName: "Isabella Garcia", status: .fulfilled, platform: .etsy, shippingCost: 2.50, sellingFees: 4.75, additionalCosts: 0.0, shippingMethod: "Standard", trackingReference: nil, customerShippingCharge: 3.99, deliveryMethod: .delivered, revenue: 56.99, profit: 49.74, productKeyword: "Bracelet", quantity: 3),
            HardcodedOrderData(daysAgo: 2, hourOffset: 11, reference: "ORD-010", customerName: "Noah Johnson", status: .fulfilled, platform: .amazon, shippingCost: 6.99, sellingFees: 18.50, additionalCosts: 2.00, shippingMethod: "Amazon Prime", trackingReference: "AMZ789DEF", customerShippingCharge: 0.0, deliveryMethod: .delivered, revenue: 249.99, profit: 222.50, productKeyword: "Samsung", quantity: 1),
            ...
            HardcodedOrderData(daysAgo: 3, hourOffset: 8, reference: "ORD-012", customerName: "William Anderson", status: .fulfilled, platform: .ebay, shippingCost: 5.50, sellingFees: 11.25, additionalCosts: 0.0, shippingMethod: "Hermes", trackingReference: "HER123456", customerShippingCharge: 6.50, deliveryMethod: .delivered, revenue: 119.99, profit: 102.74, productKeyword: "Headphones", quantity: 1),
            HardcodedOrderData(daysAgo: 3, hourOffset: 12, reference: "ORD-013", customerName: "Charlotte Taylor", status: .fulfilled, platform: .amazon, shippingCost: 4.99, sellingFees: 9.75, additionalCosts: 0.0, shippingMethod: "Amazon Logistics", trackingReference: "AMZL789", customerShippingCharge: 0.0, deliveryMethod: .delivered, revenue: 98.99, profit: 84.25, productKeyword: "Power Bank", quantity: 2),
            ...
            HardcodedOrderData(daysAgo: 4, hourOffset: 10, reference: "ORD-015", customerName: "Mia Thompson", status: .fulfilled, platform: .amazon, shippingCost: 3.99, sellingFees: 8.50, additionalCosts: 0.0, shippingMethod: "Royal Mail", trackingReference: "RG789123456GB", customerShippingCharge: 4.99, deliveryMethod: .delivered, revenue: 89.99, profit: 77.50, productKeyword: "USB", quantity: 3),
            
            // This Month (continuing with more orders)
            HardcodedOrderData(daysAgo: 7, hourOffset: 9, reference: "ORD-016", customerName: "Henry Harris", status: .fulfilled, platform: .ebay, shippingCost: 7.99, sellingFees: 19.50, additionalCosts: 1.50, shippingMethod: "UPS", trackingReference: "UPS123789", customerShippingCharge: 8.99, deliveryMethod: .delivered, revenue: 299.99, profit: 270.00, productKeyword: "Apple", quantity: 1),
            HardcodedOrderData(daysAgo: 8, hourOffset: 14, reference: "ORD-017", customerName: "Amelia Clark", status: .fulfilled, platform: .marketplace, shippingCost: 4.50, sellingFees: 6.75, additionalCosts: 0.0, shippingMethod: "DPD", trackingReference: "DPD456123", customerShippingCharge: 5.99, deliveryMethod: .delivered, revenue: 79.99, profit: 68.74, productKeyword: "Shoes", quantity: 1),
            ...
            HardcodedOrderData(daysAgo: 12, hourOffset: 16, reference: "ORD-019", customerName: "Harper Walker", status: .fulfilled, platform: .etsy, shippingCost: 3.25, sellingFees: 5.50, additionalCosts: 0.0, shippingMethod: "Standard", trackingReference: nil, customerShippingCharge: 4.50, deliveryMethod: .delivered, revenue: 64.99, profit: 55.74, productKeyword: "Scarf", quantity: 2),
            HardcodedOrderData(daysAgo: 15, hourOffset: 13, reference: "ORD-020", customerName: "Sebastian Hall", status: .fulfilled, platform: .amazon, shippingCost: 5.99, sellingFees: 12.75, additionalCosts: 0.0, shippingMethod: "Amazon Prime", trackingReference: "AMZ456GHI", customerShippingCharge: 0.0, deliveryMethod: .delivered, revenue: 159.99, profit: 141.25, productKeyword: "Mouse", quantity: 1),
            
            // Adding 80 more orders to reach 100 total...
            // I'll create a representative sample that covers the year
            HardcodedOrderData(daysAgo: 20, hourOffset: 10, reference: "ORD-021", customerName: "Victoria Allen", status: .fulfilled, platform: .ebay, shippingCost: 4.99, sellingFees: 8.25, additionalCosts: 0.0, shippingMethod: "Royal Mail", trackingReference: "RG321654987GB", customerShippingCharge: 5.50, deliveryMethod: .delivered, revenue: 94.99, profit: 81.25, productKeyword: "Converse", quantity: 1),
            ...
            HardcodedOrderData(daysAgo: 30, hourOffset: 12, reference: "ORD-023", customerName: "Madison King", status: .fulfilled, platform: .amazon, shippingCost: 6.50, sellingFees: 15.25, additionalCosts: 1.00, shippingMethod: "Amazon Logistics", trackingReference: "AMZL456", customerShippingCharge: 0.0, deliveryMethod: .delivered, revenue: 189.99, profit: 167.24, productKeyword: "Tablet", quantity: 1),
            HardcodedOrderData(daysAgo: 35, hourOffset: 9, reference: "ORD-024", customerName: "Luke Wright", status: .fulfilled, platform: .etsy, shippingCost: 2.99, sellingFees: 4.25, additionalCosts: 0.0, shippingMethod: "Standard", trackingReference: nil, customerShippingCharge: 3.99, deliveryMethod: .delivered, revenue: 49.99, profit: 42.75, productKeyword: "Wallet", quantity: 1),
            HardcodedOrderData(daysAgo: 40, hourOffset: 14, reference: "ORD-025", customerName: "Grace Lopez", status: .shipped, platform: .amazon, shippingCost: 4.50, sellingFees: 9.75, additionalCosts: 0.0, shippingMethod: "DPD", trackingReference: "DPD789456", customerShippingCharge: 5.99, deliveryMethod: .delivered, revenue: 0.0, profit: 0.0, productKeyword: "Camera", quantity: 1),
