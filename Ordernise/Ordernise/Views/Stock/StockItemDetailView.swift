...
struct StockItemDetailView: View {
    ...
    private let retailSymbols = [
        ...
        "bicycle", "gamecontroller", "headphones.circle", "camera", "desktopcomputer",
        "laptopcomputer", "iphone", "ipad", "book", "magazine", "newspaper",
        "hammer", "wrench", "screwdriver", "keyboard", "printer",
        "house", "building.2", "storefront", "tent", "bed.double", "sofa",
        "chair", "lamp.table", "lightbulb", "fan", "cup.and.saucer", "mug",
        "fork.knife.circle", "leaf", "flower", "tree", "carrot", "apple.logo",
        "dumbbell", "tennis.racket", "basketball", "football", "soccerball",
        "music.note", "guitars", "pianokeys", "mic", "speaker", "folder.fill"
    ]
    ...
    var body: some View {
        ...
        .fullScreenCover(isPresented: $showingCategoryOptions) {
            CategoryOptions()
        }
    ...
    private func saveItem() {
        ...
        do {
            ...
            // Show success toast
            let isNewItem = stockItem == nil
            
            DispatchQueue.main.async {
                ToastManager.shared.showToast(
                    type: .success,
                    title: String(localized: "Success"),
                    message: isNewItem ? String(localized: "Stock item added successfully") : String(localized: "Stock item updated successfully")
                )
            }
            ...
            DispatchQueue.main.async {
                ToastManager.shared.showToast(
                    ...
                    message: String(localized: "Failed to save stock item")
                )
            }
        }
    }
