        ...
        if fieldItem.isBuiltIn, let builtInField = fieldItem.builtInField {
            ...
            case .orderDate:
                ...
                HStack(spacing: 12) {
                    ...
                    Spacer()
                    MyDatePicker(selectedDate: $orderReceivedDate, showFutureDate: false, showBorder: false)
                ...
                VStack(spacing: 16) {
                    ...
                    HStack(spacing: 12) {
                        Image(systemName: "calendar.badge.checkmark")
                            .foregroundColor(Color.appTint)
                            .font(.title2)
                        Text(String(localized: "Completion Date"))
                        Spacer()
                        MyDatePicker(selectedDate: $orderReceivedDate, showFutureDate: true, showBorder: false)
