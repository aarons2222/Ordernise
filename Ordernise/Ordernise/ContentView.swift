...
struct ContentView: View {
  ...
  //  @State private var showOnBoarding: Bool = false
    ...
    @Query(sort: \OrderItem.quantity) private var orderItems: [OrderItem]
        ...
        ThemeSwitcher{
            ...
            ZStack(alignment: .bottom) {
                ...
                VStack {
                    ...
                    .animation(.easeInOut(duration: 0.5), value: activeTab)
            ...
            .onChange(of: activeTab) { oldValue, newValue in
                ...
                UserDefaults.standard.set(newValue.rawValue, forKey: selectedTabKey)
                
                // Update previous tab for transition direction
