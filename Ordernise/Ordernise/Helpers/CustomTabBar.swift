...
struct CustomTabBar: View {
    ...
    @AppStorage("userTintHex") private var userTintHex: String = "#4BB5EF"
    ...
    private func TabItemView(_ tab: AppTab, width: CGFloat, height: CGFloat) -> some View {
        ...
        .foregroundStyle(
            ...
            ? appTintColor
            : Color.primary.opacity(colorScheme == .dark ? 0.6 : 0.5)
        )
    ...
    private func TabBarBackground() -> some View {
        ZStack {
            Capsule(style: .continuous)
                .stroke(.gray.opacity(colorScheme == .dark ? 0.4 : 0.25), lineWidth: 1.5)
        ...
        searchLayout {
            HStack(spacing: 12) {
                Image(systemName: "magnifyingglass")
                    ...
                    .foregroundStyle(isSearchExpanded ? Color.primary.opacity(0.6) : Color.primary)
